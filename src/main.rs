...
struct Cli {
    ...
    /// Number of threads
    #[arg(short='t', long="threads", value_name = "TREADS_NUMBER", default_value_t=1)]
    threads_number: usize,

    /// Number of seconnds to pause before counters output
    #[arg(short='s', long="sleep", value_name = "SLEEP_SECS", default_value_t=1)]
    sleep: usize,
}   
...
fn main() {
    ...
    loop{
        ...
        println!("OK: {}    ERROR:{}", ok_sum - ok_sum_previous, error_sum - error_sum_previous);
